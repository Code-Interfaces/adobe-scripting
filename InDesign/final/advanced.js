...
var imagePath =
  "/Users/alvinkwabena/Documents/Alvin Ashiatey/Class/Code and Interfaces - ART 754/Workshops/Adobe scripting/InDesign/final/img.png";
...
function main() {
  if (app.activeDocument) {
    ...
    var topTextFrame = createConfiguredTextFrame(
      page,
      layer,
      "Code & Interfaces - ART 754",
      font
    );

    // https://www.indesignjs.de/extendscriptAPI/indesign-latest/#AutoSizingReferenceEnum.html
    topTextFrame.textFramePreferences.autoSizingReferencePoint =
      AutoSizingReferenceEnum.TOP_LEFT_POINT;
    topTextFrame.textFramePreferences.autoSizingType =
      AutoSizingTypeEnum.HEIGHT_ONLY;
    // https://www.indesignjs.de/extendscriptAPI/indesign-latest/#Justification.html
    topTextFrame.paragraphs.everyItem().justification =
      Justification.FULLY_JUSTIFIED;

    var bottomTextFrame = createConfiguredTextFrame(
      page,
      layer,
      "02.01.2024",
      font
    ...
    // https://www.indesignjs.de/extendscriptAPI/indesign-latest/#AutoSizingReferenceEnum.html
    bottomTextFrame.textFramePreferences.autoSizingReferencePoint =
      AutoSizingReferenceEnum.BOTTOM_LEFT_POINT;
    bottomTextFrame.textFramePreferences.autoSizingType =
      AutoSizingTypeEnum.HEIGHT_ONLY;
    // https://www.indesignjs.de/extendscriptAPI/indesign-latest/#Justification.html
    bottomTextFrame.paragraphs.everyItem().justification =
